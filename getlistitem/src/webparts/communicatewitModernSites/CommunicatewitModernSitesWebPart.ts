...
import styles from './CommunicatewitModernSitesWebPart.module.scss';
import * as strings from 'CommunicatewitModernSitesWebPartStrings';
import { SPHttpClient, SPHttpClientResponse } from '@microsoft/sp-http';

export interface ICommunicatewitModernSitesWebPartProps {
  description: string;
  listTitle: string;
}
...
export default class CommunicatewitModernSitesWebPart extends BaseClientSideWebPart<ICommunicatewitModernSitesWebPartProps> {
  ...
  private _renderListAsync(): void {
    ...
    this.domElement.innerHTML = `
        <div class='wrapper ${styles.communicatewitModernSites}'>
          ...
          <div class="${styles.grid} ${styles.communicatewitModernSites}">
             <div class="${styles.row}">
