...
import styles from './GraphapiwpdemoWebPart.module.scss';
import * as strings from 'GraphapiwpdemoWebPartStrings';

export interface IGraphapiwpdemoWebPartProps {
  description: string;
}

export default class GraphapiwpdemoWebPart extends BaseClientSideWebPart<IGraphapiwpdemoWebPartProps> {
